<footer class="footer_area">
        ...
        <div class="footer_row row">
            ...
            <div class="col-md-3 col-sm-6 footer_about">
                ...
                <address>
                    ...
                    <ul class="my_address">
                        <li><a href="#"><i class="fa fa-envelope" aria-hidden="true"></i>85ppau@gmail.com</a></li>
                        <li><a href="#"><i class="fa fa-phone" aria-hidden="true"></i>+959 964911300</a></li>
                        <li><a href="#"><i class="fa fa-map-marker" aria-hidden="true"></i><span>No.95, Insein Road, (Near Khawel Chan Bus Stop), Yangon, Myanmar.</span></a></li>
                    </ul>
                </address>
            </div>
        </div>
    ...
    <div class="copyright_area">
        Copyright 2017 All rights reserved. Designed by <a href="https://greenhackersinstitute.com">Green Hackers.</a>
    </div>
</footer>