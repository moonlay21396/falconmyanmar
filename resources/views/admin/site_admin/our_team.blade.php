                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="fb_link">Your Facebook Link</label>
                                                <input type="text" name="fb_link" class="form-control" id="fb_link" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="update_fb_link">Your Facebook Link</label>
                                                <input type="text" name="fb_link" class="form-control" id="update_fb_link" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
